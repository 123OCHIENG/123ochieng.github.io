...
You can ask me about our services, pricing, portfolio, branding, websites, academic services, or starting a project.
  ...
  if (userData.stage === "ask_email") {
    ...
    userData.stage = "ask_project";
    return "Great 👍\n\nTell me about your project. What do you want us to design or build?";
  }

  // ================= STEP 4: PROJECT =================
  if (userData.stage === "ask_project") {
    userData.project = input;
    userData.stage = "done";

    console.log("NEW CLIENT LEAD:", userData);
    ...
    setTimeout(() => {
      ...
      cta.innerHTML = `
        ...
        style="padding:10px 14px;border:none;border-radius:8px;background:#1ABC9C;color:white;cursor:pointer;">
        Start Your Project
        </button>
      `;
      document.getElementById("ai-body").appendChild(cta);
    }, 800);

    return `🔥 That sounds like a great project, ${userData.name}!\n\nWe can definitely help you achieve it professionally.`;
  }

  // ================= STEP 5: NORMAL AI (AFTER LEAD CAPTURE) =================

  if (text.includes("hello") || text.includes("hi")) {
    return `Welcome back ${userData.name || ""} 👋 How can I assist you today?`;
  }

  if (text.includes("services")) {
    return "We offer Branding, Graphic Design, UI/UX Design, Web Development, and Academic Writing.";
  }

  if (text.includes("pricing") || text.includes("cost")) {
    document.getElementById("pricing")?.scrollIntoView({ behavior: "smooth" });
    return "Our pricing depends on your project. I’ve taken you to the Pricing section 👇";
  }

  if (text.includes("portfolio") || text.includes("work")) {
    document.getElementById("portfolio")?.scrollIntoView({ behavior: "smooth" });
    return "Here are some of our past projects 👇";
  }

  if (text.includes("contact")) {
    return "You can contact us via email, phone, or the contact section on the website.";
  }

  if (text.includes("start") || text.includes("project")) {
    document.getElementById("pricing")?.scrollIntoView({ behavior: "smooth" });
    return "Let’s get started 🚀 Choose a plan or request a custom quote.";
  }

  return "I’m here to help you move forward 🚀 Ask me about services, pricing, or your project.";
}});
